...
EXEC_ALIASES = {
    "./bitcoin-util": "./blakebitcoin-util",
    "./bitcoin-tx": "./blakebitcoin-tx",
}


def resolve_exec_name(buildenv, exec_name):
    preferred = EXEC_ALIASES.get(exec_name)
    if preferred:
        preferred_path = os.path.join(buildenv["BUILDDIR"], "src", preferred + buildenv["EXEEXT"])
...
def bctest(testDir, testObj, buildenv):
    ...
    exec_name = resolve_exec_name(buildenv, testObj["exec"])
