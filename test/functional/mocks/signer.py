...
def getdescriptors(args):
    ...
    sys.stdout.write(json.dumps({
        "receive": [
            descsum_create("pkh([00000001/44'/1'/" + args.account + "']" + xpub + "/0/*)"),
            descsum_create("sh(wpkh([00000001/49'/1'/" + args.account + "']" + xpub + "/0/*))"),
            descsum_create("wpkh([00000001/84'/1'/" + args.account + "']" + xpub + "/0/*)"),
            descsum_create("tr([00000001/86'/1'/" + args.account + "']" + xpub + "/0/*)")
        ],
        "internal": [
            descsum_create("pkh([00000001/44'/1'/" + args.account + "']" + xpub + "/1/*)"),
            descsum_create("sh(wpkh([00000001/49'/1'/" + args.account + "']" + xpub + "/1/*))"),
            descsum_create("wpkh([00000001/84'/1'/" + args.account + "']" + xpub + "/1/*)"),
            descsum_create("tr([00000001/86'/1'/" + args.account + "']" + xpub + "/1/*)")
...
def displayaddress(args):
    ...
    expected_desc = {
        descsum_create("wpkh([00000001/84'/1'/0'/0/0]02c97dc3f4420402e01a113984311bf4a1b8de376cac0bdcfaf1b3ac81f13433c7)"): key_to_p2wpkh(bytes.fromhex("02c97dc3f4420402e01a113984311bf4a1b8de376cac0bdcfaf1b3ac81f13433c7")),
        descsum_create("tr([00000001/86'/1'/0'/0/0]c97dc3f4420402e01a113984311bf4a1b8de376cac0bdcfaf1b3ac81f13433c7)"): output_key_to_p2tr(bytes.fromhex("c97dc3f4420402e01a113984311bf4a1b8de376cac0bdcfaf1b3ac81f13433c7")),
    }
