...
class MempoolPackagesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_specified_wallet_compiled():
            ...
            # MiniWallet defaults to a P2TR bech32m address, which legacy wallets
            # cannot import by address. Import the raw script instead so the watch-
            # only wallet tracks the chain consistently across wallet backends.
            watch_wallet.importaddress(self.wallet.get_scriptPubKey().hex())
