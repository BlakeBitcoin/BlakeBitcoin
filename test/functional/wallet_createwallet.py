...
class CreateWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        descriptor_seed_xprv = translate_testnet_extkey("tprv8ZgxMBicQKsPcwuZGKp8TeWppSuLMiLe2d9PupB14QpPeQsqoj3LneJLhGHH13xESfvASyd4EFLJvLrG8b7DrLxEuV7hpF9uUc6XruKA1Wq")
        ...
        if self.options.descriptors:
            w3.importdescriptors([{
                'desc': descsum_create(f'wpkh({descriptor_seed_xprv}/0h/*)'),
                'timestamp': 'now',
                'active': True
            },
            {
                'desc': descsum_create(f'wpkh({descriptor_seed_xprv}/1h/*)'),
                'timestamp': 'now',
                'active': True,
                'internal': True
            }])
