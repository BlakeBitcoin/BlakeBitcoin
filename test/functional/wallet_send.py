...
class WalletSendTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        xpriv = translate_testnet_extkey("tprv8ZgxMBicQKsPfHCsTwkiM1KT56RXbGGTqvc2hgqzycpwbHqqpcajQeMRZoBD35kW4RtyCemu6j34Ku5DEspmgjKdt2qe4SvRch5Kk8B8A2v")
        xpub = translate_testnet_extkey("tpubD6NzVbkrYhZ4YkEfMbRJkQyZe7wTkbTNRECozCtJPtdLRn6cT1QKb8yHjwAPcAr26eHBFYs5iLiFFnCbwPRsncCKUKCfubHDMGKzMVcN1Jg")
        ...
        _payload, version = base58_to_byte(change_address)
        assert_equal(version, 243)
