...
class DescriptorTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.test_desc(f'pk({xpub})', isrange=False, issolvable=True, hasprivatekeys=False)
        # A P2PKH output with child key *1'/2* of the specified xpub.
        self.test_desc(f"pkh({xpub}/1'/2)", isrange=False, issolvable=True, hasprivatekeys=False)
        ...
        self.test_desc(f"pkh([d34db33f/44'/0'/0']{xpub}/1/*)", isrange=True, issolvable=True, hasprivatekeys=False)
        ...
        self.test_desc(f"wsh(multi(1,{xpub}/1/0/*,{xpub}/0/0/*))", isrange=True, issolvable=True, hasprivatekeys=False)
