...
class ImportMultiTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        xpriv = "xprv9s21ZrQH143K46GArNrbnFjQxXy7UdJhjiyQAfK2tnHgR66Z3qCKALbEqV3ZJFPZsgGEQhLk44y8bRXdtt3b24c15qXwBHh1kaHuXDAf8EJ"
        desc = "sh(wpkh(" + xpriv + "/0'/0'/*'" + "))"
        wpkh_desc = "wpkh(" + xpriv + "/0'/0'/*'" + ")"
        addresses = self.nodes[1].deriveaddresses(descsum_create(desc), [0, 1])
        addresses += self.nodes[1].deriveaddresses(descsum_create(wpkh_desc), [0, 1])
        ...
        wif_priv = "L3H2CArn24Ts3pDE83vr2cf9Ez5tghZxzNeD9Y2DT5nvfrep7jMn"
        address = "3rpcAYhT6JBCPJLPe6vFMSHkKuVWVoV2R4"
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": create_deterministic_address_bcrt1_p2tr_op_true()[0]},
                "timestamp": "now",
            },
            success=False,
            error_code=-5,
        ...
        xpub = "xpub6A9ymt3RrfmAZwdzyPFRRUTuzj6n2canQdxfUMpGzS1RAARSVDsXkpxcRwrBoKyEadebQHWbWGcokvSEogKukfLGQeBZAGHHoHXm6QvhoRc"
        ranged_wpkh_desc = 'wpkh([80002067/0h/0h]' + xpub + '/*)'
        addresses = self.nodes[1].deriveaddresses(descsum_create(ranged_wpkh_desc), [0, 4])
        result = wrpc.importmulti(
            [{
                'desc': descsum_create(ranged_wpkh_desc),
                'keypool': True,
                'timestamp': 'now',
                'range' : [0, 4],
            }]
