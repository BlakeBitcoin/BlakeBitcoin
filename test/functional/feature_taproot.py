...
class TaprootTest(BitcoinTestFramework):
    ...
    def set_test_params(self):
        ...
        self.extra_args = [["-par=1", "-acceptnonstdtxn=0"]]
    ...
    def gen_test_vectors(self):
        ...
        coinbase_value = self.nodes[0].getblocktemplate({"rules": ["segwit"]})["coinbasevalue"]
        coinbase.vout = [CTxOut(coinbase_value, CScript([OP_1]))]
        coinbase.nLockTime = 0
        coinbase.rehash()
        if coinbase_value == 5000000000:
        ...
        self.generate(self.nodes[0], TAPROOT_STRESS_FUND_BLOCKS)
        ...
        tx.vout.append(CTxOut(scaled_value(1000000000), old_spks[1]))
        tx.vout.append(CTxOut(scaled_value(3410000000), pubs[98]))
        ...
        if coinbase_value == 5000000000:
            assert_equal(hashlib.sha256(tx.serialize()).hexdigest(), "2a961212debe5aece5c99c124bc4394c9ed4dbf94e90eaa477938822bc1a6d33")
