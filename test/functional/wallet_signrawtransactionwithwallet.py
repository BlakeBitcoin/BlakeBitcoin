...
class SignRawTransactionWithWalletTest(BitcoinTestFramework):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 2
        self.extra_args = [["-testactivationheight=cltv@1"]] * self.num_nodes
    ...
    def script_verification_error_test(self):
        ...
        privKeys = ['L4HKpi5xRvkncYf7mR9r3uncFHb61Emy9ha6SmADy4Wa1zsFgRDG']
        ...
        outputs = {getnewdestination()[2]: 0.1}
