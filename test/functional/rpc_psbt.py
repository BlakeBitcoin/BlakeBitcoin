...
class PSBTTest(BitcoinTestFramework):
    ...
    def _blakebitcoinize_reference_psbt(self, psbt_b64, txid_map):
    ...
    def _maybe_blakebitcoinize_reference_psbt(self, psbt_b64, txid_map):
        try:
            return self._blakebitcoinize_reference_psbt(psbt_b64, txid_map)
        except Exception:
            return psbt_b64

    def _blakebitcoinize_reference_rawtx(self, rawtx_hex, txid_map):
        tx = CTransaction()
    ...
    def _blakebitcoinize_reference_address(self, address):
    ...
    def _blakebitcoinize_reference_wif(self, wif):
        try:
    ...
    def _load_reference_vectors(self):
        ...
        vectors["valid"] = [
            self._maybe_blakebitcoinize_reference_psbt(psbt, txid_map)
        ...
        vectors["creator"] = [
            {
                ...
                "outputs": [
                    {
                        self._blakebitcoinize_reference_address(address): amount
                        for address, amount in output.items()
                    }
                    for output in creator["outputs"]
                ],
                "result": self._maybe_blakebitcoinize_reference_psbt(creator["result"], txid_map),
            }
        ...
        vectors["signer"] = [
            {
                "privkeys": [self._blakebitcoinize_reference_wif(key) for key in signer["privkeys"]],
                "psbt": self._maybe_blakebitcoinize_reference_psbt(signer["psbt"], txid_map),
                "result": self._maybe_blakebitcoinize_reference_psbt(signer["result"], txid_map),
            }
        ...
        vectors["combiner"] = [
            {
                "combine": [self._maybe_blakebitcoinize_reference_psbt(psbt, txid_map) for psbt in combiner["combine"]],
                "result": self._maybe_blakebitcoinize_reference_psbt(combiner["result"], txid_map),
            }
        ...
        vectors["finalizer"] = [
            {
                "finalize": self._maybe_blakebitcoinize_reference_psbt(finalizer["finalize"], txid_map),
                "result": self._maybe_blakebitcoinize_reference_psbt(finalizer["result"], txid_map),
            }
        ...
        vectors["extractor"] = [
            {
                "extract": self._maybe_blakebitcoinize_reference_psbt(extractor["extract"], txid_map),
                "result": self._blakebitcoinize_reference_rawtx(extractor["result"], txid_map),
            }
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BBTC
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 BBTC/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
        ...
        assert_raises_rpc_error(-8, "Cannot specify both fee_rate (sat/vB) and feeRate (BBTC/kvB)",
        ...
        analysis = self.nodes[0].analyzepsbt(self._maybe_blakebitcoinize_reference_psbt('', self.reference_psbt_txid_map))
        assert_equal(analysis['next'], 'creator')
        assert_equal(analysis['error'], 'PSBT is not valid. Input 0 spends unspendable output')

        self.log.info("PSBT with invalid values should have error message and Creator as next")
        analysis = self.nodes[0].analyzepsbt(self._maybe_blakebitcoinize_reference_psbt('cHNidP8BAHECAAAAAfA00BFgAm6tp86RowwH6BMImQNL5zXUcTT97XoLGz0BAAAAAAD/////AgD5ApUAAAAAFgAUKNw0x8HRctAgmvoevm4u1SbN7XL87QKVAAAAABYAFPck4gF7iL4NL4wtfRAKgQbghiTUAAAAAAABAR8AgIFq49AHABYAFJUDtxf2PHo641HEOBOAIvFMNTr2AAAA', self.reference_psbt_txid_map))
        assert_equal(analysis['next'], 'creator')
        assert_equal(analysis['error'], 'PSBT is not valid. Input 0 has invalid value')

        self.log.info("PSBT with signed, but not finalized, inputs should have Finalizer as next")
        analysis = self.nodes[0].analyzepsbt(self._maybe_blakebitcoinize_reference_psbt('', self.reference_psbt_txid_map))
        assert_equal(analysis['next'], 'finalizer')

        analysis = self.nodes[0].analyzepsbt(self._maybe_blakebitcoinize_reference_psbt('cHNidP8BAHECAAAAAfA00BFgAm6tp86RowwH6BMImQNL5zXUcTT97XoLGz0BAAAAAAD/////AgCAgWrj0AcAFgAUKNw0x8HRctAgmvoevm4u1SbN7XL87QKVAAAAABYAFPck4gF7iL4NL4wtfRAKgQbghiTUAAAAAAABAR8A8gUqAQAAABYAFJUDtxf2PHo641HEOBOAIvFMNTr2AAAA', self.reference_psbt_txid_map))
        assert_equal(analysis['next'], 'creator')
        assert_equal(analysis['error'], 'PSBT is not valid. Output amount invalid')

        invalid_prevout_psbt = self._maybe_blakebitcoinize_reference_psbt('', self.reference_psbt_txid_map)
