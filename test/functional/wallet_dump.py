            ...
            if line[0] == '#':
                ...
                for addrObj in addrs:
                    if addrObj['address'] == addr.split(",")[0] and addrObj['hdkeypath'] == keypath and keytype == "label=":
                        generated_type = addrObj['generated_address_type']
                        if generated_type == 'legacy':
                            found_legacy_addr += 1
                        elif generated_type == 'p2sh-segwit':
                            found_p2sh_segwit_addr += 1
                        elif generated_type == 'bech32':
                            found_bech32_addr += 1
                        break
    ...
    def run_test(self):
        ...
        for address_type in ['legacy', 'p2sh-segwit', 'bech32']:
            for _ in range(test_addr_count):
                ...
                vaddr['generated_address_type'] = address_type
                addrs.append(vaddr)
