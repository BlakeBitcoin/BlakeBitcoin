...
MAGIC_BYTES = {
    "mainnet": b"\xf9\xbc\xa7\xb7",   # BlakeBitcoin mainnet
    "testnet3": b"\x0b\x11\x12\x09",  # BlakeBitcoin testnet
    "regtest": b"\xfa\xbf\xb5\xda",   # BlakeBitcoin regtest (matches Bitcoin/BlakeBitcoin regtest convention)
    "signet": b"\x54\xd2\x6f\xbd",    # BlakeBitcoin signet (developer-only, defaults like Bitcoin)
}
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, *, net, timeout_factor):
        ...
        logger.debug('Connecting to BlakeBitcoin Node: %s:%d' % (self.dstaddr, self.dstport))
    ...
    def peer_accept_connection(self, connect_id, connect_cb=lambda: None, *, net, timeout_factor):
        ...
        logger.debug('Listening for BlakeBitcoin Node with id: {}'.format(connect_id))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a BlakeBitcoin node.
