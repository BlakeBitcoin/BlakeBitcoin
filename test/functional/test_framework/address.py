...
"""Encode and decode BlakeBitcoin addresses.
...
ADDRESS_BCRT1_UNSPENDABLE = 'rbbtc1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqt2thvn'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(rbbtc1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqt2thvn)#9phzfesr'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'rbbtc1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsq242k04'
...
# BlakeBitcoin regtest/mainnet use xpub/xprv version bytes with Blake Base58Check
# (inherited BlakeBitcoin-family Base58 identity).
...
def create_deterministic_address_bcrt1_p2tr_op_true():
    """
    Generates a deterministic BlakeBitcoin regtest bech32m address (segwit v1 output) that
    ...
    assert_equal(address, 'rbbtc1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqsr62w7u')
