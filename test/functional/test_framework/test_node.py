#!/usr/bin/env python3
# Copyright (c) 2017-2022 The BlakeBitcoin Core developers
...
class TestNode():
    ...
    def __init__(self, i, datadir, *, chain, rpchost, timewait, timeout_factor, bitcoind, bitcoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False):
        ...
        # Configuration for logging is set as command-line args rather than in the blakebitcoin.conf file.
    ...
    def add_p2p_connection(self, p2p_conn, *, wait_for_verack=True, **kwargs):
        ...
        if wait_for_verack:
            ...
            # Consistency check that the BlakeBitcoin Core has received our user agent string. This checks the
            # node's newest peer. It could be racy if another BlakeBitcoin Core node has connected since we opened
