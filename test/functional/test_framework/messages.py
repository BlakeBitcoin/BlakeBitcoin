...
# Copyright (c) 2010-2022 The BlakeBitcoin Core developers
...
COIN = 100000000  # 1 BBTC in satoshis
...
class CBlockLocator:
    ...
    def serialize(self):
        r = b""
        r += struct.pack("<i", 0)  # BlakeBitcoin Core ignores version field. Set it to 0.
