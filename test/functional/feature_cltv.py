...
CLTV_HEIGHT = COINBASE_MATURITY + 25
...
class BIP65Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Depending on the configured maturity/test harness path, buried
        # deployment reporting may flip at this boundary. The consensus
        # assertion below is the important one: the next block must obey
        # CLTV/version rules.
