...
BLAKEBITCOIN_REGTEST_POW_LIMIT_BITS = "207fffff"
BLAKEBITCOIN_REGTEST_TARGET_SPACING = 3 * 60
...
class SegWitTest(BitcoinTestFramework):
    ...
    def build_next_block(self):
        ...
        block_time = max(tip_header["mediantime"] + 1, tip_header["time"] + 1)
        if tip_header["bits"] != BLAKEBITCOIN_REGTEST_POW_LIMIT_BITS:
            block_time = max(block_time, tip_header["time"] + 2 * BLAKEBITCOIN_REGTEST_TARGET_SPACING + 1)
