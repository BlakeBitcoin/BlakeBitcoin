...
class RPCGenerateTest(BitcoinTestFramework):
    ...
    def test_generatetoaddress(self):
        self.generatetoaddress(self.nodes[0], 1, key_to_p2pkh('0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798'))
    ...
    def test_generateblock(self):
        ...
        combo_address = key_to_p2wpkh(combo_key)
        ...
        combo_address = key_to_p2pkh(combo_key)
        hash = self.generateblock(node, 'combo(' + combo_key + ')', [])['hash']
        block = node.getblock(hash, 2)
        assert_equal(len(block['tx']), 1)
        assert_equal(block['tx'][0]['vout'][0]['scriptPubKey']['address'], combo_address)
        ...
        ranged_descriptor = 'pkh(' + translate_testnet_extkey('tpubD6NzVbkrYhZ4XgiXtGrdW5XDAPFCL9h7we1vwNCpn8tGbBcgfVYjXyhWo4E1xkh56hjod1RhGjxbaTLV3X4FyWuejifB9jusQ46QzG87VKp') + '/0/*)'
        ...
        child_descriptor = 'pkh(' + translate_testnet_extkey('tpubD6NzVbkrYhZ4XgiXtGrdW5XDAPFCL9h7we1vwNCpn8tGbBcgfVYjXyhWo4E1xkh56hjod1RhGjxbaTLV3X4FyWuejifB9jusQ46QzG87VKp') + "/0'/0)"
