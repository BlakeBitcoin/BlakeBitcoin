...
# Keep enough pre-activation mature coinbase outputs for BlakeBitcoin's ported
# funding-heavy SegWit checks. The original Bitcoin value left this test one
# or more 50-BBTC UTXOs short under the BlakeBitcoin regtest maturity/subsidy
