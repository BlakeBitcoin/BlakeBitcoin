...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BBTC and create transactions
        ...
        # generate some BBTC to create transactions and check blockcount
        ...
        # send 10 BBTC to user's first watch-only address
        self.log.info('Send 10 BBTC to user')
        ...
        # send 5 BBTC to our second watch-only address
        self.log.info('Send 5 BBTC to user')
        ...
        # send 1 BBTC to our third watch-only address
        self.log.info('Send 1 BBTC to user')
