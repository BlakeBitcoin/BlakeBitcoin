...
class KeyPoolTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.options.descriptors:
            ...
            hardened_xprv = translate_testnet_extkey("tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK")
            nodes[0].walletpassphrase('test', 10)
            nodes[0].importdescriptors([
                {
                    "desc": descsum_create(f"wpkh({hardened_xprv}/0h/*h)"),
                    "timestamp": "now",
                    "range": [0,0],
                    "active": True
                },
                {
                    "desc": descsum_create(f"pkh({hardened_xprv}/1h/*h)"),
                    "timestamp": "now",
                    "range": [0,0],
                    "active": True
                },
                {
                    "desc": descsum_create(f"sh(wpkh({hardened_xprv}/2h/*h))"),
                    "timestamp": "now",
                    "range": [0,0],
                    "active": True
                },
                {
                    "desc": descsum_create(f"wpkh({hardened_xprv}/3h/*h)"),
                    "timestamp": "now",
                    "range": [0,0],
                    "active": True,
                    "internal": True
                ...
                {
                    "desc": descsum_create(f"pkh({hardened_xprv}/4h/*h)"),
                    "timestamp": "now",
                    "range": [0,0],
                    "active": True,
                    "internal": True
                ...
                {
                    "desc": descsum_create(f"sh(wpkh({hardened_xprv}/5h/*h))"),
                    "timestamp": "now",
                    "range": [0,0],
                    "active": True,
                    "internal": True
