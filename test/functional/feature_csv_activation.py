...
CSV_ACTIVATION_HEIGHT = max(432, COINBASE_MATURITY + COINBASE_BLOCK_COUNT + 5)
...
class BIP68_112_113Test(BitcoinTestFramework):
    ...
    def create_self_transfer_from_utxo(self, input_tx):
        ...
        tx = self.miniwallet.create_self_transfer(utxo_to_spend=utxo, fee_rate=Decimal(CSV_SELF_TRANSFER_FEE_RATE))['tx']
        return tx
