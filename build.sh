...
WINDOWS_EXE_ICON_ICO="$SCRIPT_DIR/src/qt/res/icons/blakebitcoin_32.ico"
WINDOWS_EXE_ICON_TESTNET_ICO="$SCRIPT_DIR/src/qt/res/icons/blakebitcoin_32_testnet.ico"
