...
public:
    ...
    /** Read only the serialized block header at this index, including AuxPoW payload when present. */
    bool ReadBlockHeader(CBlockHeader& block, const CBlockIndex& index) const;
