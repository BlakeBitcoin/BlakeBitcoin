...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; // blakebitcoin-tx using stdin
...
{
    // Windows: C:\Users\Username\AppData\Roaming\BlakeBitcoin
    // macOS: ~/Library/Application Support/BlakeBitcoin
    // Unix-like: ~/.blakebitcoin
#ifdef WIN32
    // Windows
