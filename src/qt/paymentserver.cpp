...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click blakebitcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start blakebitcoin: click-to-pay handler");
    else
...
{
    // clicking on blakebitcoin: URLs creates FileOpen events on the Mac:
