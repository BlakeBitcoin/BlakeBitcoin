...
BOOST_AUTO_TEST_CASE(block_subsidy_test)
{
    ...
    TestBlockSubsidyHalvings(main_params->GetConsensus()); // BlakeBitcoin mainnet
    TestBlockSubsidyHalvings(testnet_params->GetConsensus()); // BlakeBitcoin testnet
    TestBlockSubsidyHalvings(regtest_params->GetConsensus()); // BlakeBitcoin regtest
...
BOOST_AUTO_TEST_CASE(subsidy_limit_test)
{
    ...
    BOOST_CHECK_EQUAL(nSum, CAmount{2099999997690000LL});
}
...
//! Test retrieval of valid assumeutxo values. BlakeBitcoin regtest carries one
//! snapshot at height 110 with a BlakeBitcoin-specific txoutset hash.
BOOST_AUTO_TEST_CASE(test_assumeutxo)
{
    ...
    BOOST_CHECK_EQUAL(
        ...
        "01a89c199e5800105a7d6ea026c5985eacde9e684f33e32beab24c3039f10547");
...
BOOST_AUTO_TEST_CASE(block_malleation)
{
...

    {
        ...
        uint256 merkle_collision_candidate;
        {
            ...
            // tree inner nodes using the same hash function. BlakeBitcoin txids are
        ...
        // reproduces the original merkle root under BlakeBitcoin's hash policy.
        block.vtx.clear();
