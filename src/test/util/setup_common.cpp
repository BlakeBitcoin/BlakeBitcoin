    ...
    : TestingSetup{CBaseChainParams::REGTEST, extra_args, coins_db_in_memory, block_tree_db_in_memory}
{
...

    {
        ...
        // BlakeBitcoin regtest deterministic 100-block-chain tip hash. The donor
        // BlakeBitcoin-25.2 had its own tip hash here; switching to BlakeBitcoin
        // regtest's distinct genesis produces a different chain.
        if (tip_hash != "560e80da26dfa4dc389ee779f3644d0f560238e0d5df5dc4e0d1ad4f302e484c") {
