#!/usr/bin/env python3
# Copyright (c) 2020-2022 The BlakeBitcoin Core developers
...
parser = argparse.ArgumentParser(description='Script to get coins from a faucet.', epilog='You may need to start with double-dash (--) when providing blakebitcoin-cli arguments.')
parser.add_argument('-c', '--cmd', dest='cmd', default='blakebitcoin-cli', help='blakebitcoin-cli command to use')
...
parser.add_argument('-a', '--addr', dest='addr', default='', help='BlakeBitcoin address to which the faucet should send')
...
parser.add_argument('bitcoin_cli_args', nargs='*', help='Arguments to pass on to blakebitcoin-cli (default: -signet)')
