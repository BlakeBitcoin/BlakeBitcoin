#!/usr/bin/env bash
# Copyright (c) 2019-2022 The BlakeBitcoin Core developers
...
(
    ...
    # Setup the directory where our BlakeBitcoin Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built BlakeBitcoin Core to $INSTALLPATH
    case "$HOST" in
        *darwin*)
    ...
    (
        ...
        # copy over the example blakebitcoin.conf file. if contrib/devtools/gen-blakebitcoin-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/blakebitcoin.conf" "${DISTNAME}/"
