...
To build BlakeBitcoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      BlakeBitcoin Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/t./blakebitcoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.co./blakebitcoin-core/guix.sigs).
