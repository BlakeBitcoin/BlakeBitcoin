#!/usr/bin/env python3
# Copyright (c) 2021 The BlakeBitcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

""" Interactive blakebitcoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for BlakeBitcoin Core can enable. It uses BCC
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("USAGE:", sys.argv[0], "path/to/blakebitcoind")
        exit()
    path = sys.argv[1]
    main(path)
