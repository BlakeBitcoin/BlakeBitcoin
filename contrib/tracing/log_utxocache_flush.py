#!/usr/bin/env python3
# Copyright (c) 2021-2022 The BlakeBitcoin Core developers
...
"""Example logging BlakeBitcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/blakebitcoind
