...
As of BlakeBitcoin Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.co./blakebitcoin-core/guix.sigs/). When
...
builder-keys](https://github.co./blakebitcoin-core/guix.sigs/tree/main/builder-keys) and
...
This script checks BlakeBitcoin release checksums and corresponding
`SHA256SUMS.asc` signatures from the configured release location.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Download./blakebitcoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Download./blakebitcoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
