#!/usr/bin/env python3
# Copyright (c) 2020-2021 The BlakeBitcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Script for verifying BlakeBitcoin Core release binaries.
...
The builder keys are available in the guix.sigs repo:
    ...
    https://github.com/blakebitcoin-core/guix.sigs/tree/main/builder-keys
...
VERSIONPREFIX = "blakebitcoin-core-"
...
def verify_shasums_signature(
   ...
   ReturnCode, t.List[SigData], t.List[SigData], t.List[SigData], t.List[SigData]
    ...
    # which pubkeys within the BlakeBitcoin community do we trust for the purposes of
    # binary verification?
    trusted_keys = set()
