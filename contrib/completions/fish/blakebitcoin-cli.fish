...
complete --command blakebitcoin-cli --no-files
...
complete --command blakebitcoin-cli \
...
# Add commands
# Permit command completions after `blakebitcoin-cli help` but not after other commands
complete \
    --command blakebitcoin-cli \
    --no-files \
