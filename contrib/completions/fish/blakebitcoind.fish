...
complete --command blakebitcoind --no-files

# Extract options
function __fish_blakebitcoind_get_options
...
complete \
    --command blakebitcoind \
    --arguments "(__fish_blakebitcoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command blakebitcoind \
...
complete \
    --command blakebitcoind \
    --arguments "(__fish_blakebitcoind_get_options --nofiles)"
