...
Below are some notes on how to build BlakeBitcoin Core for Windows.
...
way. This will install to `c:\workspace\blakebitcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/blakebitcoin
